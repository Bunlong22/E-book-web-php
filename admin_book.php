			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<?php while ($row = mysqli_fetch_assoc($result)) { ?>
						<tr>
							<td class="px-2 py-1 align-middle"><a href="book.php?bookisbn=<?php echo $row['book_isbn']; ?>"
									target="_blank"><?php echo $row['book_isbn']; ?></a></td>
							...
							<td class="px-2 py-1 align-middle">
								...
								<img class="img-top" width="100%" height="150px"
									src="./public/img/<?php echo $row['book_image']; ?>">
							</td>
							<td class="px-2 py-1 align-middle">
							...
							<td class="px-2 py-1 align-middle text-center">
								<div class="btn-group btn-group-sm">
									...
									<a href="admin_edit.php?bookisbn=<?php echo $row['book_isbn']; ?>"
										class="btn btn-sm rounded-0 btn-primary m-2" title="Edit"><i
											class="fa fa-edit"></i></a>
									<a href="admin_delete.php?bookisbn=<?php echo $row['book_isbn']; ?>"
										class="btn btn-sm rounded-0 btn-danger m-2" title="Delete"
										onclick="if(confirm('Are you sure to delete this book?') === false) event.preventDefault()"><i
